    ...
    try {
      ...
      try {
        ...
        return res.json({
          ...
          advice: '१. कार्बेन्डाजिम (५० WP) का २ ग्राम प्रति लीटर पानी में मिलाकर छिड़काव करें।\n२. नाइट्रोजन युक्त खादों का अत्यधिक उपयोग बंद करें।\n३. रोग प्रतिरोधी किस्मों का उपयोग करें और खेत में उचित जल निकासी बनाए रखें।'
        });
      }
    ...
    try {
      ...
      try {
        ...
        if (lowerQ.includes('गेहूं') || lowerQ.includes('wheat')) {
          matchedCrop = 'गेहूं';
          answer = 'गेहूं की फसल के लिए न्यूनतम समर्थन मूल्य (MSP) ₹२,२७५ प्रति क्विंटल है। बुवाई के समय नाइट्रोजन, फास्फोरस और पोटाश का सही संतुलन रखें। कीट नियंत्रण के लिए आवश्यकतानुसार फफूंदनाशक का प्रयोग करें।';
        } else if (lowerQ.includes('धान') || lowerQ.includes('paddy') || lowerQ.includes('rice') || lowerQ.includes('चावल')) {
          matchedCrop = 'धान';
          answer = 'धान (चावल) की फसल के लिए इस वर्ष का MSP ₹२,१८३ प्रति क्विंटल है। फसल में पीलापन होने पर जिंक सल्फेट (०.५%) और यूरिया का छिड़काव लाभदायक होता है। जल प्रबंधन का विशेष ध्यान रखें।';
        } else if (lowerQ.includes('कपास') || lowerQ.includes('cotton')) {
          matchedCrop = 'कपास';
          answer = 'कपास का MSP ₹६,६२० प्रति क्विंटल है। गुलाबी सुंडी (Pink Bollworm) से बचाव के लिए फेरोमोन ट्रैप लगाएं और आवश्यकता पड़ने पर अनुशंसित कीटनाशकों का छिड़काव करें।';
        } else if (lowerQ.includes('मक्का') || lowerQ.includes('maize')) {
          matchedCrop = 'मक्का';
          answer = 'मक्का का वर्तमान मण्डी भाव (MSP) ₹२,०९० प्रति क्विंटल है। फसल में दीमक नियंत्रण के लिए बीज उपचार अवश्य करें और खेत में जलभराव न होने दें।';
        }
